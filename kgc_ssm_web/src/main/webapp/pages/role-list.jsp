							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除" onclick="location.href='${pageContext.request.contextPath}/role/deleteById.do?id=${role.id}'">
							...
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
									<c:if test="${pageInfo.pageNum==pageNum}">
										<li class="active"><a href="${pageContext.request.contextPath}/role/findAll.do?page=${pageInfo.pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
									</c:if>
									<c:if test="${pageInfo.pageNum!=pageNum}">
										<li><a href="${pageContext.request.contextPath}/role/findAll.do?page=${pageInfo.pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
									</c:if>
								</c:forEach>
