...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/orders/updateOrder.do"
				  method="post">
			<!-- 正文区域 -->
			...
			<!--联系人信息/--> <!--费用信息--> <c:if test="${orders.orderStatus==1}">
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-3 data text">在线支付-${orders.payTypeStr}</div>
						<div class="col-md-1 title">支付状态</div>
						<div class="col-md-3 data text">${orders.orderStatusStr}</div>
